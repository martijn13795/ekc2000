        ...
        <div id="links">
            ...
            if ($pics->count()) {
                foreach ($pics->results() as $pic) {
                    ...
                    if ($user->isLoggedIn() && ($user->data()->id == $pic->user_id || $user->hasPermission("dev") || $user->hasPermission("imageremove"))) { echo '<div class="imageDel"><i class="fa fa-trash-o imageDelButton" onclick="imageDel(\''. escape($pic->id) .'\', \''. escape($pic->pathMobile) .'\');"></i></div>';}
