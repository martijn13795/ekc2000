                    ...
                    <div class="col-md-4 col-xs-12 homeInfoDiv">
                        <div class="col-xs-12 col-md-12 well infoDiv">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <p>
                                    <?php
                                    $reports = $db->query("SELECT * FROM reports ORDER BY date DESC LIMIT 6");
...
<!--                    </div>-->
<!--                </div>-->
                <div class="col-md-6 col-xs-12 chatRow">
                ...
                <div class="col-md-6 col-xs-12 chatRow" style="text-align: center;">
