                        ...
                        if ($date) {
                            ...
                            if ($emails->count()) {
                                ...
                                foreach ($emails->results() as $email) {
                                    $userName = $email->name;
                                    $text = 'Hallo ' . $userName . ',<br><br>' . 'Er is een nieuw wedstrijdverslag geüpload: ' . $name . '.<br>'.'Bekijk hem nu: <a target="_blank" href="https://ekc2000.nl/verslag/' . rawurlencode($name) . '">https://ekc2000.nl/verslag/' . rawurlencode($name) . '</a><br>';
                                    $to = $email->mail;
