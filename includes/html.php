<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/core/init.php'; ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://<?php echo $_SERVER['SERVER_NAME']; ?>/fonts/font-awesome/css/font-awesome.min.css">
        <!-- Bootstrap -->
        <link href="https://<?php echo $_SERVER['SERVER_NAME']; ?>/css/bootstrap.min.css" rel="stylesheet">
        <link href="https://<?php echo $_SERVER['SERVER_NAME']; ?>/css/<?php if(isset($_COOKIE["darkTheme"]) && $_COOKIE["darkTheme"] === "true") { echo "dark-"; }?>style.css" rel="stylesheet">
        ...
        <![endif]-->
        <script src="https://<?php echo $_SERVER['SERVER_NAME']; ?>/js/jquery-2.2.2.min.js" type="text/javascript"></script>
